...
fun MyColorChangingScreen(modifier: Modifier =Modifier){
    ...
    //Estado para navegar por la lista de colores
    ...
    Column(
        ...
        Column(
            //Se establece el color de fondo con el color en el indice (0-5)'CurrentColorIndex' de la lista
            ...
            Button(onClick = {
                /*Se incremeta en 1 el indice de navegacion actual y se obtiene el modulo del tamanio de la lista
                  de modo que si el indice tiene valor 6 -> 6%6 = 0. Regrese al inicio de la lista.
                * */
